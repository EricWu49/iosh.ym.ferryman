...
namespace Ferryman.Utility
{
    public static class ShareFunction
    {
        ...
        public static object Register_Close_Script(Page myPage, string WindowName = "closewin", string MessageString = "")
        {
            ...
            {
                strScript = "<script type=\"text/javascript\">" + VB.sCR()  + "window.alert('" + MessageString + "');" + VB.sCR() + "window.opener=null;   " + VB.sCR() + "window.open('','_self');   " + "window.close(); " + "</script>";
            }
            else
            {
                strScript = "<script type=\"text/javascript\">" + VB.sCR() + "window.opener=null;   " + VB.sCR() + "window.open('','_self');   " + "window.close(); " + "</script>";
            }
        ...
        public static object Register_Close_And_Redirect_Script(Page myPage, string ParentLocation, string MessageString = "")
        {
            ...
            if (string.IsNullOrEmpty(MessageString))
            {
                strScript = "<script type=\"text/javascript\">" + VB.sCR() + "window.parent.location='" + ParentLocation + "';" + VB.sCR() + "window.opener=null;   " + VB.sCR() + "window.open('','_self');   " + "window.close(); " + "</script>";
            }
            else
            {
                strScript = "<script type=\"text/javascript\">" + VB.sCR() + "window.alert('" + MessageString + "');" + VB.sCR() + "window.parent.location='" + ParentLocation + "';" + VB.sCR() + "window.opener=null;   " + VB.sCR() + "window.open('','_self');   " + "window.close(); " + "</script>";
            }
        ...
        public static object Register_Close_And_Reload_Script(Page myPage, string MessageString = "")
        {
            ...
            if (string.IsNullOrEmpty(MessageString))
            {
                strScript = "<script type=\"text/javascript\">" + VB.sCR() + "window.opener.location.reload();" + VB.sCR() + "window.opener=null;   " + VB.sCR() + "window.open('','_self');   " + "window.close(); " + "</script>";
            }
            else
            {
                strScript = "<script type=\"text/javascript\">" + VB.sCR() + "window.alert('" + MessageString + "');" + VB.sCR() + "window.opener.location.reload();" + VB.sCR() + "window.opener=null;   " + VB.sCR() + "window.open('','_self');   " + "window.close(); " + "</script>";
            }
            if (!myPage.ClientScript.IsClientScriptBlockRegistered("self_close"))
            {
                myPage.ClientScript.RegisterClientScriptBlock(myPage.GetType(), "self_close", strScript);
        ...
        public static void Register_Redirect_Script(Page myPage, string URLPath, bool Parent = false)
        {
            ...
            if (Parent)
            {
                strScript = strScript + "window.parent.location='" + URLPath + "';" + VB.sCR();
            }
            else
            {
                strScript = strScript + "window.location='" + URLPath + "';" + VB.sCR();
            }
        ...
        public static void Register_ReLoad_Script(Page myPage, bool Parent = false)
        {
            ...
            if (Parent)
            {
                strScript = strScript + "window.opener.location.reload();" + VB.sCR();
            }
            else
            {
                strScript = strScript + "window.location.reload();" + VB.sCR();
            }
            strScript = strScript + "</script>" + VB.sCR();
        ...
        public static string GetRandomString()
        {
            ...
            return Counter.Next().ToString("0000000000");
        }
    }
