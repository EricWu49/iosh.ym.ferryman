<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Body021.aspx.cs" Inherits="iosh.Body021" %>
                    ...
                    <p>
                        ...
                        <div>
                            <asp:RadioButtonList ID="rdbOption" runat="server" ClientIDMode="AutoID" CssClass="option-item" RepeatDirection="Horizontal" RepeatLayout="Flow" QuestionID='<%# Eval("QuestionID")%>'>
                                <asp:ListItem Value="2">沒影響</asp:ListItem>
                                <asp:ListItem Value="3">影響工作表現</asp:ListItem>
                            </asp:RadioButtonList>
                        </div>
                    </p>
                </ItemTemplate>
