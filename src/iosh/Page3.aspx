<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Page3.aspx.cs" Inherits="iosh.Page3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FormContentPlaceHolder" runat="server">
    ...
    <asp:ListBox ID="lstOption" Visible="false" runat="server"></asp:ListBox><asp:Label ID="lblIndex" runat="server" Text="" Visible="false"></asp:Label>
    <div class="row" style="margin-top: 10px;">
