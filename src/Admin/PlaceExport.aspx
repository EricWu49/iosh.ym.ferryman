<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PlaceExport.aspx.cs" Inherits="Admin.PlaceExport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div id="Panel_Setting" class="easyui-panel" title="工作環境危害因子 資料匯出" style="width:100%;height:80px;padding:10px;">
        <span>資料統計區間：</span>
